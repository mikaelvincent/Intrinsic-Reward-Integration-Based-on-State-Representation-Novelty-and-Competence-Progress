...
In this regime, GLPE (no gate) is statistically indistinguishable from the strongest baseline (ICM) at the final checkpoint (Table~\ref{tab:final_returns_glpe_vs_baselines}); the threshold analysis below shows that many runs reach competent behavior without consistently clearing the full solved cutoff.
