...
The gated variant provides its clearest benefit on the exploration-limited \textsc{MountainCar-v0} task, where it achieves the best final return (Table~\ref{tab:final_returns_glpe_vs_baselines}).
...
\textsc{MountainCar-v0} is more sensitive: despite GLPE leading by environment steps, the best time-AUC is attained by RIAC, indicating that intrinsic compute can dominate when environment interaction is cheap and learning progresses quickly.
