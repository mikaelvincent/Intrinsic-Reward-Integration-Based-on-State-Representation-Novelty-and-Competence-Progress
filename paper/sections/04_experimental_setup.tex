...
We compare two proposed intrinsic-reward methods, GLPE and GLPE (no gate) (Section~\ref{sec:method}), against a set of commonly used exploration baselines: Vanilla PPO, ICM, RND, RIDE, and RIAC.
