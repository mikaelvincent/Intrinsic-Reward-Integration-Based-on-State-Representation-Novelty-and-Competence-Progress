...
We evaluate both GLPE variants on \textsc{MountainCar-v0}, \textsc{BipedalWalker-v3}, and three MuJoCo locomotion tasks (\textsc{Ant-v5}, \textsc{HalfCheetah-v5}, \textsc{Humanoid-v5}), comparing against widely used intrinsic-reward baselines including ICM \cite{pathak-2017}, RND \cite{burda-2018B}, RIDE \cite{raileanu-2020}, and RIAC \cite{baranes-2009}.
