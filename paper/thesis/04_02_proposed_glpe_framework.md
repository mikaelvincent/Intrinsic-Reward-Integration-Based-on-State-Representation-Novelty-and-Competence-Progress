...
\]
where \(\widetilde{I}_t\) and \(\widetilde{\mathrm{LP}}_t\) were RMS-normalized components and \(\alpha_{\mathrm{impact}},\alpha_{\mathrm{LP}}\ge 0\) were mixing weights [15], [2], .
