...
The gated variant is most useful in sparse-reward settings such as \textsc{MountainCar-v0}, where suppressing high-error, low-progress regions improves reliability, but it can be conservative in dense-reward or high-variance tasks.
