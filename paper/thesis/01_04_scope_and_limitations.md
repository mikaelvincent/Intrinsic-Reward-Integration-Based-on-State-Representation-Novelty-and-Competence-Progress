...
Experimental scope was restricted to five Gymnasium benchmarks, namely MountainCar-v0, BipedalWalker-v3, Ant-v5, HalfCheetah-v5, and Humanoid-v5, under fixed environment reward functions and termination rules . Comparisons were limited to Vanilla PPO, ICM, RND, RIDE, and RIAC using common training budgets, aligned checkpoint schedules, and deterministic offline evaluation from saved checkpoints [6], [15], [2], [19], [18], .
