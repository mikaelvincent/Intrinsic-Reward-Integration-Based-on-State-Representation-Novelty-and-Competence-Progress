...
The symbol B denotes the number of parallel environment instances, T denotes rollout horizon per instance, and N = B x T denotes transitions per PPO update [18].
