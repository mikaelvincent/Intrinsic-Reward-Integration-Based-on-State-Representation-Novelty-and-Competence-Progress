...
This behavior can improve reliability in sparse-reward settings, but it can also become conservative in high-variance environments where temporary low progress does not necessarily imply that a region should be ignored.
