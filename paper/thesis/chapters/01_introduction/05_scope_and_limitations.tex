...
GLPE is evaluated on five Gymnasium control benchmarks: \textsc{MountainCar-v0}, \textsc{BipedalWalker-v3}, \textsc{Ant-v5}, \textsc{HalfCheetah-v5}, and \textsc{Humanoid-v5}.
...
The GLPE intrinsic reward is evaluated as a shaping signal rather than as a policy-invariant transformation of the original reward.
...
The experimental comparison is limited to PPO, ICM, RND, RIDE, RIAC, and the GLPE variants.
