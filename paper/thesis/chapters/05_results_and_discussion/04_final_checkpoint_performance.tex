...
\hline
\end{fitwidthtabular}
\caption[Final-checkpoint returns]{Final-checkpoint mean extrinsic return under deterministic offline evaluation. Brackets show 95\% bootstrap confidence intervals over seeds. Higher values are better.}
