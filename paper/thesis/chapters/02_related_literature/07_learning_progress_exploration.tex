...
The idea appears in early work on curiosity and model-building controllers, where an agent is motivated by changes in its ability to predict the consequences of its actions \parencite{schmidhuber-1991}.
...
Oudeyer and Kaplan describe intrinsic motivation systems that use competence progress and learning progress to guide autonomous development \parencite{oudeyer-2007A,oudeyer-2007B}.
...
R-IAC applies this principle through adaptive partitioning and region-specific progress estimates \parencite{baranes-2009}.
