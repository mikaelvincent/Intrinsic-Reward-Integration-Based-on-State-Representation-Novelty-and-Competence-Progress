...
Generalized Advantage Estimation (GAE) improves the bias--variance tradeoff of advantage computation by combining temporal-difference residuals over multiple horizons \cite{schulman-2015}.
Let
\begin{equation}
...
Proximal Policy Optimization (PPO) is a policy-gradient method designed to constrain each policy update so that optimization remains stable under minibatch stochastic gradient descent \cite{schulman-2017}.
