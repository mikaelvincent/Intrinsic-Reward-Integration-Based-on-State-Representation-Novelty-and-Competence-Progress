...
This chapter reports comparative results for GLPE, GLPE without gating, Vanilla PPO, ICM, RND, RIDE, and RIAC on the five-task benchmark suite defined in Chapter 4 {{CIT:2,6,13,15,19}}. Consistent with the evaluation protocol, reported task performance uses deterministic offline evaluation and extrinsic return unless explicitly stated otherwise.
