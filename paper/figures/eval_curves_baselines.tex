\begin{figure*}[t]
\centering
\includegraphics[width=0.98\linewidth]{figures/eval-curves-baselines-curves.png}
\caption{
Evaluation learning curves for GLPE and baseline intrinsic-reward methods.
Each panel plots mean \emph{extrinsic} return (higher is better) versus environment interaction steps for one task.
