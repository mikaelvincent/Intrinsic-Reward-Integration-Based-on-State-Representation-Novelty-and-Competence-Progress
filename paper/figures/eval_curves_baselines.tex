\begin{figure}[!hbp]
\centering
\includegraphics[width=\glpefigwidth,height=\glpefigheight,keepaspectratio]{figures/eval-curves-baselines-curves.png}
\caption{
...
These curves summarize learning speed and stability across seeds; tight clustering of per-seed markers indicates robust performance.
}
