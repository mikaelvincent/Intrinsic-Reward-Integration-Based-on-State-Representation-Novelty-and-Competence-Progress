\begin{figure*}[t]
\centering
\includegraphics[width=0.98\linewidth]{figures/steps-to-beat-baselines.png}
\caption{
Sample efficiency and reliability at fixed return thresholds.
For each task, bars report the median number of training steps required to first reach a target return level, computed by linearly interpolating between evaluation checkpoints.
