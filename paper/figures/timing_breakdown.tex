\begin{figure}[!hbp]
\centering
\includegraphics[width=\glpefigwidth,height=\glpefigheight,keepaspectratio]{figures/timing-breakdown.png}
\caption{
...
This view helps interpret wall-clock trade-offs: larger intrinsic segments indicate greater exploration overhead, while larger environment-step segments indicate simulation-dominated regimes.
}
