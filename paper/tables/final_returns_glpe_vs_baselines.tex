...
\textsc{BipedalWalker-v3} & $266.5\;[214.0,301.3]$ & $294.4\;[285.9,303.7]$ & Vanilla: $302.2\;[291.2,309.4]$ \\
...
\end{tabular}
\caption{
Mean extrinsic return at the final checkpoint (latest by training steps). Values are means over seeds; each seed is evaluated for 20 deterministic (mode) episodes, and confidence intervals are 95\% bootstrap intervals over seeds.
