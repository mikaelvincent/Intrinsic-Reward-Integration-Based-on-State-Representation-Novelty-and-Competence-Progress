...
Each cell reports the number of seeds that reached the task's solved-return threshold by the end of training and the median steps (in millions) to first reach it, computed by linearly interpolating between deterministic evaluation checkpoints (Figure~\ref{fig:steps_to_threshold_baselines}).
