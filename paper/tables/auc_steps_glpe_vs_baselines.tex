...
\end{tabular}
\caption{
Normalized AUC of deterministic evaluation return versus cumulative environment steps, computed by trapezoidal integration of the mean return--by--steps curve over evaluation checkpoints and dividing by the environment's step budget.
...
The best baseline is selected (per environment) among Vanilla PPO, ICM, RND, RIDE, and RIAC by highest mean normalized AUC.
}
