...
\caption{
Decomposition of rollout reward during training.
...
This plot is a diagnostic for the optimization signal and complements the evaluation curves, which report extrinsic return without intrinsic shaping.
}
